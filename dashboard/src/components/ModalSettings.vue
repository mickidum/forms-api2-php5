<template>
  <div class="inner" v-if="settingsItem">
    ...
    <form @submit.prevent="saveSettings" class="pure-form pure-form-stacked">
      ...
      <div class="pure-g">
        <!-- ITEMS NAMES BLOCK -->
        <div class="pure-u-1 pure-u-lg-1-3 l-box">
            ...
            <template>
              <div class="validate-container">
                <div v-for="(item, key) in settingsItem.mail" class="items-names">
                  ...
                  >{{!settingsItem.mail.send ? 'Click for enable mail' : 'Click for disable mail'}}</span>
            ...
            <template>
              <div class="items-names">
                <div class="validate-container">
                  ...
                  >{{!settingsItem.validation.validate ? 'Click for validate' : 'Click for disable validation'}}</span>
                  <br />
                  <template v-if="settingsItem.items_names">
                    ...
                    <div v-for="item in settingsItem.items_names" class="validate-items">
                      ...
                      >
                        <input
                          type="checkbox"
                          v-model="settingsItem.validation.validate_items"
                          :value="item.name"
                        />
                      </label>
